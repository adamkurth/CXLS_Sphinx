...
For more information on the :doc:`external software <external_software>` please refer page in the hyperlink, as well as to the following link:

- `CrystFEL <https://www.desy.de/~twhite/crystfel/>`_

This page will provide a brief overview of how to submit jobs using SLURM on the AGAVE supercomputer cluster using external software. 
...
*For more information and helpful RC documentaion please refer to.* :doc:`AGAVE <access/agave>`
