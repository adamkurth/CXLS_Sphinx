...
.. raw:: html
    ...
    <div class="contact-section" style="text-align: right;">
        <button onclick="toggleContactInfo1()" class="contact-button">Person of Contact 1</button>
...
.. raw:: html
    ...
    <div class="contact-section" style="text-align: right;">
        <button onclick="toggleContactInfo2()" class="contact-button">Person of Contact 2</button>
